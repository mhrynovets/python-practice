...
def main():
    ...
    if len(sys.argv) > 2:
        raise Exception('Wrong arguments given. Filename with spaces '
...
# don't found standards - how to find, where to stop discovery
#   of nested extensions,
# so i think, that it should be the last part.
# Nested containers will have own extensions.
